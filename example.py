...
from auction.util import getBalances, getAppAddress, getAppGlobalState, getLastBlockTimestamp
from auction.testing.setup import getAlgodClient
from auction.testing.resources import getTemporaryAccount, optInToAsset, createDummyAsset
...
def simple_auction():
    ...
    print('Alice is creating auction smart contract that lasts 30 seconds to auction off NFT...')
